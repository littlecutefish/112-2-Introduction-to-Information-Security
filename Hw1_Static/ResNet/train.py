...
def main():
    ...
    data_root = os.path.abspath(os.path.join(os.getcwd(), "/Users/liuliyu/Desktop/malware"))  # get data root path
    image_path = os.path.join(data_root)  # data set path
    assert os.path.exists(image_path), "{} path does not exist.".format(image_path)
    train_dataset = datasets.ImageFolder(root=os.path.join(image_path, "train_split"),
    ...
    with open('class_indices_split.json', 'w') as json_file:
    ...
    validate_dataset = datasets.ImageFolder(root=os.path.join(image_path, "val_split"),
