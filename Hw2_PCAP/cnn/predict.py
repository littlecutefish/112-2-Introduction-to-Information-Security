...
# 載入類別索引
with open(r"C:\Users\User\Desktop\Malware\Hw2_PCAP\class_indices.json") as f:
    class_indices = json.load(f)

# 載入模型
model = tf.keras.models.load_model(r"C:\Users\User\Desktop\Malware\Hw2_PCAP\cnn\malware_cnn_model_new.h5")
