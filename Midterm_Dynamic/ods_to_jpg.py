...
# 读取 Excel 文件
excel_file = r"C:\Users\User\Desktop\Malware\Midterm_Dynamic\calls_data_2.xlsx"
...
# 讀取Excel文件
df = pd.read_excel(r"C:\Users\User\Desktop\Malware\Midterm_Dynamic\color_mapping.xlsx", index_col=0)
